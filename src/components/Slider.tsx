...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-purple-200 dark:bg-purple-800">
      <SliderPrimitive.Range className="absolute h-full bg-purple-900  dark:bg-purple-400" />
